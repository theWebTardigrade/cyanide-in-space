...
## USE COMPILATION FROM MATUS
#### Graciá-Carpio 2008 #### z=0
...
plt.ylabel(r"$L'_{\mathrm{HCO}^+(1-0)}$ [K km s$^{-1}$ pc$^2$]", fontsize=16)
...
def UL(x, y, color, label, edgecolor=None, size=None, zorder=5, marker_new=None):
    plt.plot([x,x], [0.70*y, y], c = color, lw=2 , zorder = zorder) 
...
###########################################################################################################################
#### Graciá-Carpio 2008 #### z=0
plt.scatter(GC2008_LFIR, GC2008_LHCO, color = '#9093A2FF', marker='x', label = 'z~0', zorder=5, s=20)

### Krips 2008 #### z=0
plt.scatter(Krips_LFIR, Krips_LHCO, color = '#9093A2FF', marker='x', label = 'z~0', zorder=5, s=20)

###  Graciá Burillo 2012 #### z=0
plt.scatter(GB2012_LFIR, GB2012_LHCO, color = '#9093A2FF', marker='x', label = 'z~0', zorder=5, s=20)

### Privon 2015 #### z=0
plt.scatter(Privon_LFIR, Privon_LHCO, color = '#9093A2FF', marker='x', label = 'z~0', zorder=5, s=20)
...
rybak_color = '#4285f4'
rybak_size = 7
plt.errorbar(66e12/8.8, 85e8/(0.36*8.8), yerr=130e8/8.8, color = rybak_color, mec='black', label = 'Rybak 2026', zorder=5, markersize=rybak_size, fmt='s') #SDP.9
plt.errorbar(64e12/10.9, (73e8/(0.36*10.9)), yerr=25e8/(0.36*10.9), color = rybak_color, mec='black', label = 'Rybak 2026', zorder=5, markersize=rybak_size, fmt='s') #SDP.11
plt.errorbar(66e12/15.3, (113e8/(0.36*15.3)), yerr=19e8/(0.36*15.3), color = rybak_color, mec='black', label = 'Rybak 2026', zorder=5, markersize=rybak_size, fmt='s')#G09v1.40
plt.errorbar(71e12/4.9, (80e8/(0.27*4.9)), yerr=16e8/(0.27*4.9), color = rybak_color, mec='black', label = 'Rybak 2026', zorder=5, markersize=rybak_size, fmt='s') #SDP.17
UL(28e12/1.8, (75e8/(0.27*1.8)), color = rybak_color, label = 'Rybak 2026', size=50, marker_new='s') #G15v2.235
plt.errorbar(133e12/14.7, (310e8/(0.36*14.7)), yerr=19e8/(0.36*14.7), color = rybak_color, mec='black', label = 'Rybak 2026', zorder=5, markersize=rybak_size, fmt='s') #J0209
plt.errorbar(40e12,  (61e8/(0.27)), yerr=15e8/(0.27),color = rybak_color, mec='black', label = 'Rybak 2026', zorder=5, markersize=rybak_size, fmt='s') #G09v1.326
UL(32e12/8.6, (140e8/(8.6)), color = rybak_color, label = 'Rybak 2026', size=50, marker_new='s') # SDP.130
plt.errorbar(75e12/4.1, (170e8/(0.27*4.1)), yerr=30e8/(0.27*4.1), color = rybak_color, mec='black', label = 'Rybak 2026', zorder=5, markersize=rybak_size, fmt='s') #NAv1.195
plt.errorbar(43e12/18.2, 160e8/(0.27*18.2), yerr=43e8/(0.27*18.2), color = rybak_color, mec='black', label = 'Rybak 2026', zorder=5, markersize=rybak_size, fmt='s') #SDP.81
plt.errorbar(90e12/9.2, (146e8/(0.27*9.2)), yerr=14e8/(0.27*9.2), color = rybak_color, mec='black', label = 'Rybak 2026', zorder=5, markersize=rybak_size, fmt='s') #G12v2.43
...
my_color = '#9900ff'
my_size= 15
UL(2.2e14, 5.2e10, color = my_color, edgecolor='#9900ff', label = 'This work', size=50, zorder=10, marker_new='o') # W2246
plt.errorbar(1.77e14/8.3, 8.7e10/8.3, yerr=2.9e10/8.3, color = my_color, mec='black', label = 'This work', zorder=10, markersize=my_size, fmt='.') # J1336
plt.errorbar(4.60e14/28.2, 26.4e10/28.2, yerr=4.3e10/28.2, color = my_color, mec='black', label = 'This work', zorder=10, markersize=my_size, fmt='.') # J0226
plt.errorbar(2.3e14/7.6, 6.6e10/7.6, yerr=2.0e10/7.6, color = my_color, mec='black', label = 'This work', zorder=10, markersize=my_size, fmt='.') # J1053
plt.errorbar(8.110e13/25, 12.1e10/25, yerr=2.3e10/25, color = my_color, mec='black', label = 'This work', zorder=10, markersize=my_size, fmt='.') # J1202
plt.errorbar(12e13/8, (9.6e10/8), yerr=(1.9e10/8), color = my_color, mec='black', label = 'This work', zorder=6, markersize=my_size, fmt='.') # J1323
UL(7.4e13/32.5, 4.6e10/32.8, color = my_color, edgecolor='#9900ff', label = 'This work', size=50, zorder=10, marker_new='o') # Eyelash
UL(10.06e13/11.7, 10.4e10/32.8, color = my_color, edgecolor='#9900ff', label = 'This work', size=50, zorder=10, marker_new='o') # Nav1.56
UL(4.11e13/6.1, 4.63e10/6.1, color = my_color, edgecolor='#9900ff', label = 'This work', size=50, zorder=10, marker_new='o') # J213+0109
plt.errorbar(9.23e13/57, 2.7e10/57, yerr=1.6e10/57, color = my_color, mec='black', label = 'This work', zorder=10, markersize=my_size, fmt='.') # J0116
plt.errorbar(3.90e14/11, 19.0e10/11, yerr=2.2e10/11, color = my_color, mec='black', label = 'This work', zorder=10, markersize=my_size, fmt='.') # Eyebrow
...
############################################################################################################################################
# # Fit first SINGLE LINMIX
# max_value = max(len(all_LFIR), len(all_LHCO))

# log_xvalues = np.log10(all_LFIR[0:92])
# log_yvalues = np.log10(all_LHCO[0:92])

# log_yerrs = np.array(all_LHCO_errs[0:92]) / (np.array(all_LHCO[0:92]) * np.log(10))

# linmix_model = linmix.LinMix(log_xvalues, log_yvalues, ysig=log_yerrs, delta=detections_flags[0:92])
...
# print(f"Best-fit slope: {slope1:.2f}")
# print(f"Best-fit intercept: {intercept1:.2f}")
# print(f"Scatter: {scatter1:.2f}")

# # Best-fit trend line
# x_line = np.logspace(9, 15, 300)

# # linmix works in log space
...
# # ######################################################################
# # Fit second SINGLE LINMIX

# log_xvalues = np.log10(all_LFIR[92:])
# log_yvalues = np.log10(all_LHCO[92:])
# log_yerrs = np.array(all_LHCO_errs[92:]) / (np.array(all_LHCO[92:]) * np.log(10))


# linmix_model = linmix.LinMix(log_xvalues, log_yvalues, ysig=log_yerrs, delta=detections_flags[92:]) 
# linmix_model.run_mcmc(silent=True)

# # Plot the results 
# # Extract posterior medians 
# alpha_chain2 = linmix_model.chain['alpha']
# beta_chain2 = linmix_model.chain['beta']

# alpha_med2 = np.median(alpha_chain2)
# alpha_lo2, alpha_hi2 = np.percentile(alpha_chain2, [16, 84])

# beta_med2 = np.median(beta_chain2)
# beta_lo2, beta_hi2 = np.percentile(beta_chain2, [16, 84])

# scatter2 = np.sqrt(np.median(linmix_model.chain['sigsqr']))

# intercept2 = alpha_med2
# slope2 = beta_med2

# print(f"Best-fit slope: {slope2:.2f}")
# print(f"Best-fit intercept: {intercept2:.2f}")
# print(f"Scatter: {scatter2:.2f}")

# # Best-fit trend line
# x_line = np.logspace(9, 15, 300)

# # Linear fit works in log space
# log_y_line = intercept2 + slope2 * np.log10(x_line)

# # Convert back to linear space
# y_line = 10**log_y_line

# trend_color2 = '#2CA030FF'
...
# scatter_total = np.sqrt(
#     ((N1 - 1) * scatter1**2 +
#      (N2 - 1) * scatter2**2)
#     / ((N1 - 1) + (N2 - 1))
# )

# print('Total Scatter', scatter_total)

#######################################################################
# # Fit everything with LinMix
...
# Residuals relative to the global LinMix fit
...
handles += [
    # Line2D([0], [0], color=trend_color1, lw=2),
    # Line2D([0], [0], color=trend_color2, lw=2),
...
labels += [
    # z ~ 0
    # rf"$L'_\mathrm{{HCN}} = "
    # rf"10^{{{intercept1:.2f}_{{-{intercept1-alpha_lo1:.2f}}}"
    # rf"^{{+{alpha_hi1-intercept1:.2f}}}}}"
    # rf"L_\mathrm{{FIR}}^{{{slope1:.2f}_{{-{slope1-beta_lo1:.2f}}}"
    # rf"^{{+{beta_hi1-slope1:.2f}}}}}$",


    # # high z
    # rf"$L'_\mathrm{{HCN}} = "
    # rf"10^{{{intercept2:.2f}_{{-{intercept2-alpha_lo2:.2f}}}"
    # rf"^{{+{alpha_hi1-intercept2:.2f}}}}}"
    # rf"L_\mathrm{{FIR}}^{{{slope2:.2f}_{{-{slope2-beta_lo2:.2f}}}"
    # rf"^{{+{beta_hi2-slope2:.2f}}}}}$",
    
    # # Fit of everything
    rf"$L'_\mathrm{{HCO^+}} = "
    rf"10^{{{intercept3:.2f}_{{-{intercept3-alpha_lo3:.2f}}}"
    rf"^{{+{alpha_hi3-intercept3:.2f}}}}}"
    rf"L_\mathrm{{FIR}}^{{{slope3:.2f}_{{-{slope3-beta_lo3:.2f}}}"
    rf"^{{+{beta_hi3-slope3:.2f}}}}}$"
]
...
plt.savefig('/home/polaris/cyanide_in_space/scripts/prussic-main/prussic_iii/literature_data/HCO+_vs_FIR_fit.png', dpi = 200,bbox_inches='tight')
